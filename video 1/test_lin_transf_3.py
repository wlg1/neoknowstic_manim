...
#         self.add(numberplane)
        ...
        c = np.array([4.3, 2.5, 0])  #goes to [1,1]
        vec_c = Vector(list(c), buff=0, color='grey',
            stroke_width=4, max_tip_length_to_length_ratio=0.1, 
            max_stroke_width_to_length_ratio=3)
