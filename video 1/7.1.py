...
class scene_7_1(Scene):
    def construct(self):
        ...
        ####################
        self.play(FadeOut(nose_unit_1, nose_space, nap_space, noseName, napName, nose_unit_2_b, nose_unit_1_copy, ear_unit_1_copy, purp_vec, ear_space, ear_unit_1, ear_unit_1_copy, earName, eqn_1, eqn_2))
