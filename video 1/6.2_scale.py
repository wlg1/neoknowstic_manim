...
class scene_6_2(Scene):
    def construct(self):
        ...
        # nose_group_vert_2 = VGroup(face_outline.copy(), nose_scaled.copy(), box.copy()).scale(0.2).move_to([0,new_y,0])

        # nose_vec_line = Line([0,0,0],[0, new_y - 0.2, 0], color=BLUE)
        # nose_vec_line.z_index = 5
        # nose_vec_tip = Triangle(fill_color=BLUE, fill_opacity=1, color=BLUE).scale(0.07).rotate(360*DEGREES).move_to([0, new_y - 0.2, 0])
        # nose_vec_tip.z_index = 5
        # nose_vec_vert_2 = VGroup(nose_vec_line, nose_vec_tip)

        ##
        # nose_group_nap_2_2 = ear_group_vert_2.copy().move_to(nap_space_2.number_to_point(new_y_nap)).shift(UP*0.2)
        
        nose_group_nap_2 = VGroup(face_outline.copy(), nose.copy(), box.copy()).scale(0.2).move_to(nap_space_2.number_to_point(new_x_nap)).shift(UP*0.2)  
        ...
        # ear_vec_tip_nap_2.z_index = 5
        # nose_unit_nap_2_2 = VGroup(ear_vec_line_nap_2, ear_vec_tip_nap_2).shift(UP*0.1)
        ...
        # nose_group_nap_2 = ear_group_1.copy().move_to(nap_space_2.number_to_point(0.75)).shift(UP*0.2)
        
        # ear_vec_line_nap_2 = Line(nap_space_2.number_to_point(0), nap_space_2.number_to_point(0.7), color='#ADD8E6', fill_opacity=0.9)
        # ear_vec_line_nap_2.z_index = 5
        # ear_vec_tip_nap_2 = Triangle(fill_color='#ADD8E6', fill_opacity=0.9, color='#ADD8E6').scale(0.07).rotate(-90*DEGREES).move_to(nap_space_2.number_to_point(0.7))
        # ear_vec_tip_nap_2.z_index = 5
        # nose_unit_nap_2 = VGroup(ear_vec_line_nap_2, ear_vec_tip_nap_2).shift(UP*0.1)
